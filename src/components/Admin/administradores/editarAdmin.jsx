...
const CardEditarAdmin = ({adminDataEdit, setEditarAdmin, setDataAdminChange, updateListAdmins, messageToast}) => {

    const [adminData, setAdminData] = useState(adminDataEdit)
    ...
    const handleChangeEstado = (event) => {
        ...
        setAdminData({
            ...adminData,
            [event.target.name]: valorEstado
        });
    }


    const cancelEditarAdmin = () => {
        setEditarAdmin(false)
        setDataAdminChange({})
    }
    ...
    const editarAdmin = () => {
        ...
        API.put('/keys/update/admins', adminData, {headers:{token: localToken}})
        .then(response => {
            messageToast('Administrador actualizado', 'success')
            updateListAdmins()
            cancelEditarAdmin()
                ...
                <div className=" bg-white h-auto tracking-wide border border-black-800 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center ">
                            ...
                            >
                                ...
                                <select className="block w-full " name="estado" value={adminData.estado===0? 'false' : 'true'} onChange={handleChangeEstado}>
                                    <option>true</option>
                                    <option>false</option>
                                </select>
                            </div>
...
export default CardEditarAdmin
