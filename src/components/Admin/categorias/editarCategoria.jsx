...
const CardEditarCategoria = ({categoriaEdit, setEditarCategoria, setCategoria, updateListCategorias, messageToast}) => {

    const [categoriaData, setCategoriaData] = useState(categoriaEdit)
    ...
    const editarCategoria = () => {
        ...
        bodyFormData.append('_id', categoriaData._id);
        bodyFormData.append('name', categoriaData.name);
        API.put('/categorias/update', bodyFormData, {headers:{token: localToken}})
        .then(response => {
            messageToast('Categoria actualizada', 'success')
            updateListCategorias()
            cancelEditarCategoria()
            ...
            <div className="w-1/2 lg:float-right">
                <div className=" bg-white h-auto tracking-wide border border-black-800 rounded-lg">
...

                        {
                            ...
                            :
                                <div className=" rounded-2xl flex justify-center my-6">
                                    <img className="h-40 rounded-2xl w-40 object-cover" src={categoriaData.imagen.secure_url} alt="imagen" />
                                </div>
                        }
...
export default CardEditarCategoria
